export default {
  ...
  technicalSkills: [
    ...
    { title: 'Redux', years: 1, level: 50 },
    { title: 'Nextjs', years: 3, level: 75 },
    { title: 'Jest', years: 3, level: 60 },
    { title: 'Cypress', years: 3, level: 70 },
    { title: 'Storybook', years: 1, level: 55 },
