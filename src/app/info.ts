export default {
  ...
  technicalSkills: [
    { title: 'HTML5', experience: 8 },
    { title: 'CSS3', experience: 8 },
    { title: 'Javascript', experience: 8 },
    { title: 'Typescript', experience: 4 },
    { title: 'Nodejs', experience: 6 },
    { title: 'Expressjs', experience: 3 },
    { title: 'RESTful API design', experience: 3 },
    { title: 'Graphql', experience: 3 },
    { title: 'Reactjs', experience: 5 },
    { title: 'Redux', experience: 1 },
    { title: 'Nextjs', experience: 3 },
    { title: 'Jest', experience: 3 },
    { title: 'Cypress', experience: 3 },
    { title: 'Storybook', experience: 1 },
    { title: 'SQL', experience: 3 },
    { title: 'Sequelize ORM', experience: 1 },
    { title: 'Mongodb', experience: 2 },
    { title: 'Mongoose ODM', experience: 2 },
    { title: 'Contentful', experience: 3 },
    { title: 'Git', experience: 6 },
    { title: 'Github', experience: 3 },
    { title: 'Linux', experience: 5 },
    { title: 'Bash', experience: 5 },
    { title: 'Design patterns', experience: 8 },
    { title: 'Gulp', experience: 1 },
    { title: 'Socket.io', experience: 1 },
    { title: 'Deepstream', experience: 1 },
    { title: 'Redis', experience: 1 },
    { title: 'Docker', experience: 1 },
    { title: 'JSON', experience: 6 },
    { title: 'JSON schema', experience: 1 },
    { title: 'Mocha', experience: 1 },
    { title: 'Chai', experience: 1 },
    { title: 'Enzyme', experience: 1 },
    { title: 'Tailwind CSS', experience: 1 },
    { title: 'SASS', experience: 1 },
    { title: 'Yeoman', experience: 1 }
  ],
  softSkills: [
