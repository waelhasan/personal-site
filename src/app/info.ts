export default {
  ...
  technicalSkills: [
    { title: 'HTML5', years: 8, level: 90 },
    { title: 'CSS3', years: 8, level: 80 },
    { title: 'Javascript', years: 8, level: 90 },
    { title: 'Typescript', years: 4, level: 70 },
    { title: 'Nodejs', years: 6, level: 70 },
    { title: 'Expressjs', years: 3, level: 80 },
    { title: 'RESTful API design', years: 3, level: 80 },
    { title: 'Graphql', years: 3, level: 70 },
    { title: 'Reactjs', years: 5, level: 80 },
    { title: 'Redux', years: 1, level: 70 },
    { title: 'Nextjs', years: 3, level: 70 },
    { title: 'Jest', years: 3, level: 70 },
    { title: 'Cypress', years: 3, level: 70 },
    { title: 'Storybook', years: 1, level: 50 },
    { title: 'SQL', years: 3, level: 70 },
    { title: 'Sequelize ORM', years: 1, level: 60 },
    { title: 'Mongodb', years: 2, level: 70 },
    { title: 'Mongoose ODM', years: 2, level: 70 },
    { title: 'Contentful', years: 3, level: 70 },
    { title: 'Git', years: 6, level: 70 },
    { title: 'Github', years: 3, level: 60 },
    { title: 'Linux', years: 5, level: 60 },
    { title: 'Bash', years: 5, level: 60 },
    { title: 'Design patterns', years: 8, level: 70 },
    { title: 'Gulp', years: 1, level: 70 },
    { title: 'Socket.io', years: 1, level: 60 },
    { title: 'Deepstream', years: 1, level: 70 },
    { title: 'Redis', years: 1, level: 60 },
    { title: 'Docker', years: 1, level: 60 },
    { title: 'JSON', years: 6, level: 80 },
    { title: 'JSON schema', years: 1, level: 80 },
    { title: 'Mocha', years: 1, level: 70 },
    { title: 'Chai', years: 1, level: 70 },
    { title: 'Enzyme', years: 1, level: 70 },
    { title: 'Tailwind CSS', years: 1, level: 50 },
    { title: 'SASS', years: 1, level: 60 },
