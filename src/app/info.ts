export default {
  ...
  technicalSkills: [
    { title: 'HTML5', years: 8 },
    { title: 'CSS3', years: 8 },
    { title: 'Javascript', years: 8 },
    { title: 'Typescript', years: 4 },
    { title: 'Nodejs', years: 6 },
    { title: 'Expressjs', years: 3 },
    { title: 'RESTful API design', years: 3 },
    { title: 'Graphql', years: 3 },
    { title: 'Reactjs', years: 5 },
    { title: 'Redux', years: 1 },
    { title: 'Nextjs', years: 3 },
    { title: 'Jest', years: 3 },
    { title: 'Cypress', years: 3 },
    { title: 'Storybook', years: 1 },
    { title: 'SQL', years: 3 },
    { title: 'Sequelize ORM', years: 1 },
    { title: 'Mongodb', years: 2 },
    { title: 'Mongoose ODM', years: 2 },
    { title: 'Contentful', years: 3 },
    { title: 'Git', years: 6 },
    { title: 'Github', years: 3 },
    { title: 'Linux', years: 5 },
    { title: 'Bash', years: 5 },
    { title: 'Design patterns', years: 8 },
    { title: 'Gulp', years: 1 },
    { title: 'Socket.io', years: 1 },
    { title: 'Deepstream', years: 1 },
    { title: 'Redis', years: 1 },
    { title: 'Docker', years: 1 },
    { title: 'JSON', years: 6 },
    { title: 'JSON schema', years: 1 },
    { title: 'Mocha', years: 1 },
    { title: 'Chai', years: 1 },
    { title: 'Enzyme', years: 1 },
    { title: 'Tailwind CSS', years: 1 },
    { title: 'SASS', years: 1 },
    { title: 'Yeoman', years: 1 }
  ],
  softSkills: [
